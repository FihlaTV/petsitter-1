...
class PetsImCaringForController: UITableViewController {
    ...
    @IBAction func addPet(sender: AnyObject) {
        let alert = UIAlertController(title: "Add Pet Code", message: "Enter the pet code provided by the pet owner.", preferredStyle: UIAlertControllerStyle.Alert)
        alert.addAction(UIAlertAction(title: "Submit", style: UIAlertActionStyle.Default, handler: nil))
        alert.addAction(UIAlertAction(title: "Cancel", style: UIAlertActionStyle.Default, handler: nil))
        alert.addTextFieldWithConfigurationHandler({(textField: UITextField!) in
            textField.placeholder = "Enter pet code:"
